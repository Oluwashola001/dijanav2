...
const CONTENT = {
  en: {
    ...
    table: {
      title: "Selected Premieres",
      headers: ["Year", "Event / Venue", "Work"],
      rows: [
        { year: "2024", event: "Munich Philharmonic, Künstlerhaus Munich", work: "Con Fretta (string trio), Memories (string quartet)" },
        { year: "2024", event: "Theater Erfurt, Large House", work: "Light and Shadow for Holy Saturday" },
        { year: "2024", event: "Munich Philharmonic, German Embassy Beijing", work: "Con Fretta (string trio)" },
        { year: "2019", event: "BR-Klassik – Musik der Welt", work: "Music from Belgrade with composer Dijana Bošković" },
        { year: "2018", event: "Forum, University of Music and Theatre Hamburg", work: "ONE (large orchestra)" },
        { year: "2017", event: "Laeiszhalle, Small Hall, Hamburg", work: "Concert piece from TRANSIT (mezzo-soprano and piano)" },
        { year: "2017", event: "Benefit Concert Sternstunden, Munich Residence", work: "Between East and West (flute and tape)" },
        { year: "2017", event: "St. Reinoldi Church, Dortmund", work: "Dona Nobis Pacem Shanti" },
        { year: "2016", event: "International Chamber Music Course, Austria", work: "Sundance (piano trio)" },
        { year: "2016", event: "Resonanzraum Hamburg", work: "Lichtspiele / Light Plays (violin, cello, piano)" },
        ...
        { year: "2014", event: "Altach Organ Soirée", work: "Conversations with Death (flute and organ)" },
        { year: "2013", event: "CD Release – Begegnungen / Encounters", work: "Chamber Music, Cavalli Records" },
        { year: "2009", event: "BEMUS International Music Festival, Belgrade", work: "Concerto for Strings" },
        { year: "2008", event: "Carl Orff Hall, Gasteig, Munich", work: "Divertimento for strings" },
        { year: "2007", event: "BEMUS International Music Festival, Belgrade", work: "Versus Vox Integra (sextet)" },
  ...
  de: {
    ...
    news: [
      {
        ...
        content: [
          ...
          "Neben Strauss’ Variationen über „Das Dirndl is harb auf mi“ für Streichtrio Nr. 109 sowie dem Streichquartett A-Dur op. 2 erklangen Boškovićs neueste Werke aus dem Jahr 2024: Für meine Mutter und Konturlos für Streichquartett sowie das Streichtrio Con Fretta.",
      ...
      },
      {
        ...
        title: "Media Vita – Ātman Aeternus",
        source: "Eine Kontemplation zwischen abendländischer Tradition und vedischer Weisheit",
        content: [
    ...
    table: {
      ...
      rows: [
        { year: "2024", event: "Münchner Philharmoniker · Künstlerhaus München", work: "Memories – Streichquartett" },
        { year: "2024", event: "Licht und Schatten am Karsamstag · Theater Erfurt, Großes Haus", work: "Black and White – Klavierduo" },
        { year: "2024", event: "Münchner Philharmoniker · Deutsche Botschaft Peking", work: "Con Fretta – Streichtrio" },
        { year: "2019", event: "Musik der Welt · BR Klassik", work: "Musik aus Belgrad mit Dijana Bošković" },
        { year: "2018", event: "Hamburger Symphoniker · Forum Hochschule für Musik und Theater Hamburg", work: "ONE – für großes Orchester" },
        { year: "2017", event: "Laeiszhalle Hamburg · Kleiner Saal", work: "Konzertstück aus TRANSIT – Mezzosopran & Klavier" },
        { year: "2017", event: "Benefizkonzert Sternstunden · Allerheiligen-Hofkirche, München", work: "Between East and West – Flöte & Tonband" },
        { year: "2017", event: "St. Reinoldi-Kirche Dortmund · Liveübertragung Deutschlandfunk Kultur", work: "Dona Nobis Pacem Shanti – Gewinnerkomposition für gemischten Chor" },
        { year: "2016", event: "Internationaler Kammermusikkurs · Österreich", work: "Sonnentanz – Klaviertrio" },
        { year: "2016", event: "Resonanzraum Hamburg", work: "Lichtspiele – Violine, Violoncello, Klavier" },
        { year: "2015", event: "Neue Musik im Gespräch · Ensemble plus · ORF Landesfunkhaus", work: "Suite für Violine und Cello" },
        { year: "2014", event: "Altacher Orgelsoirée", work: "Gespräche mit dem Tod – Flöte und Orgel" },
        { year: "2013", event: "CD-Veröffentlichung Cavalli Records · Bamberg", work: "Begegnungen / Encounters" },
        { year: "2009", event: "BEMUS International Music Festival · Belgrad", work: "Concerto for Strings, Konzert mit den St. Petersburger Solisten" },
        { year: "2008", event: "Carl-Orff-Saal · Gasteig München", work: "Divertimento für Streicher" },
        { year: "2007", event: "BEMUS International Music Festival · Belgrad", work: "Versus Vox Integra - Sextett" },
                  ...
                  {currentContent.news.map((item, index) => (
                    ...
                    >
                      <div className="border-l-4 border-[#ff6643] pl-4">
                        <h3 className="text-sm font-serif uppercase tracking-widest text-[#ff6643] mb-1">
                          {item.category}
                        </h3>
              ...
              <section id="broadcasts" className="scroll-mt-32">
                ...
                <div className="bg-[#2D2D2D] border border-[#CCCCCC] overflow-x-auto">
                  <table className="w-full table-fixed">
                    <thead>
                      <tr className="bg-[rgba(255,102,67,1)] text-white">
                    ...
                    <tbody>
                      {currentContent.table.rows.map((item, index) => (
                        ...
                        >
                          <td className="px-2 md:px-6 py-3 text-[rgba(255,102,67,1)] font-body font-semibold text-xs md:text-base break-words">
                            {item.year}
                          </td>
