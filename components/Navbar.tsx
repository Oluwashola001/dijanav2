...
export default function Navbar() {
  ...
  const isNewsPage = pathname === '/news' || pathname === '/discography' || pathname === '/ensembles' || pathname === '/ensembles/light-plays' || pathname === '/ensembles/emigres-waltz' || pathname === '/ensembles/encounters' || pathname === '/ensembles/between-east-and-west';
